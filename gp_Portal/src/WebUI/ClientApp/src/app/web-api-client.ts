...
export interface ILineaBEClient {
    get(): Observable<LineaVm>;
    create(command: CreateLineaBECommand): Observable<number>;
    update(id: number, command: UpdateLineaBECommand): Observable<FileResponse>;
...
export class LineaBEClient implements ILineaBEClient {
    ...
    get(): Observable<LineaVm> {
        let url_ = this.baseUrl + "/api/LineaBE";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<LineaVm>;
                }
            } else
                return _observableThrow(response_) as any as Observable<LineaVm>;
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<LineaVm> {
        ...
        if (status === 200) {
            ...
            result200 = LineaVm.fromJS(resultData200);
    ...
    update(id: number, command: UpdateLineaBECommand): Observable<FileResponse> {
        let url_ = this.baseUrl + "/api/LineaBE/{id}";
...
export class ServiciosLineaClient implements IServiciosLineaClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    update(id: number, command: UpdateServiciosLineaCommand): Observable<FileResponse> {
        let url_ = this.baseUrl + "/api/ServiciosLinea/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
        ...
        if (_data) {
            if (Array.isArray(_data["lists"])) {
                ...
                for (let item of _data["lists"])
                    this.lists!.push(LineaDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): LineaVm {
        data = typeof data === 'object' ? data : {};
        let result = new LineaVm();
        result.init(data);
        return result;
    }
...
export class LineaDto implements ILineaDto {
    ...
    static fromJS(data: any): LineaDto {
        data = typeof data === 'object' ? data : {};
        let result = new LineaDto();
        result.init(data);
        return result;
    }
...
export class CreateLineaBECommand implements ICreateLineaBECommand {
    ...
    constructor(data?: ICreateLineaBECommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateLineaBECommand {
        data = typeof data === 'object' ? data : {};
        let result = new CreateLineaBECommand();
        result.init(data);
        return result;
    }
...
export interface ICreateLineaBECommand {
    name?: string | undefined;
    route?: string | undefined;
    direction?: number;
    status?: boolean;
...
export class UpdateLineaBECommand implements IUpdateLineaBECommand {
    id?: number;
    name?: string | undefined;
    route?: string | undefined;
    direction?: number;
    ...
    constructor(data?: IUpdateLineaBECommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UpdateLineaBECommand {
        data = typeof data === 'object' ? data : {};
        let result = new UpdateLineaBECommand();
        result.init(data);
        return result;
    }
...
export interface IUpdateLineaBECommand {
    id?: number;
    name?: string | undefined;
    route?: string | undefined;
    direction?: number;
...
export class CreateServiciosLineaCommand implements ICreateServiciosLineaCommand {
    ...
    constructor(data?: ICreateServiciosLineaCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateServiciosLineaCommand {
        data = typeof data === 'object' ? data : {};
        let result = new CreateServiciosLineaCommand();
        result.init(data);
        return result;
    }
...
export class UpdateServiciosLineaCommand implements IUpdateServiciosLineaCommand {
    ...
    constructor(data?: IUpdateServiciosLineaCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UpdateServiciosLineaCommand {
        data = typeof data === 'object' ? data : {};
        let result = new UpdateServiciosLineaCommand();
        result.init(data);
        return result;
    }
